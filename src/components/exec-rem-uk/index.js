...
const ExecutiveBenchmarkUK = ({ sectors }) => {
  ...
  const getCompaniesCount = (data) => {
    ...
    AxiosInstance.post("api/benchmark/companies-count-uk", formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
  ...
  const getIndustries = (data) => {
    ...
    AxiosInstance.post("api/benchmark/industries-uk", formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
  ...
  const getCompaniesCountByMetrics = () => {
    ...
    AxiosInstance.post("api/benchmark/companies-count-metrics-uk", formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
  ...
  const getCompaniesCountByTogether = () => {
    ...
    AxiosInstance.post("api/benchmark/companies-hand/count-uk", formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export default ExecutiveBenchmarkUK;
