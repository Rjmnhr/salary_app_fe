...
const LinearSalaryChartDemo = ({ data }) => {
        ...
        <div style={{ height: "100px", width: "50%" }}>
          ...
          <div className="w-100 d-flex justify-content-between">
            <div className="w-100 text-start mt-2">
              ...
              >
                {decimalFix(data["25th Percentile"])} LPA
              </p>
            </div>
            ...
            <div className="w-100 text-right mt-2">
              ...
              >
                {decimalFix(data["75th Percentile"])} LPA
              </p>
            </div>
          </div>
        </div>
...
export default LinearSalaryChartDemo;
